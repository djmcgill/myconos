...
#gcost 0
#size 4
#descr "I've been sent here to the outher rim of the Pythian empire. A place of fungus creatures,  called Myconos. Aparently they are our long time allies and it is said we learned how to communion from them. Their nation is in disarray and the population is infected with parasites. Duke is here for research. I'm here to secure any advantages in new warfare technology. Nothing is shunned. - Voland"
#end
...
#descr "While Duke has infected local wildlife I extracted some parasite eggs from a dead myconid corpse and mixed them with the legionaires dinner. The effects are quite stunning! Mucusy lesions have already formed on their skin and their movement seems controlled by the parasite, but they do follow any command given to them. - Voland "
#magicboost 6 -2
#end
...
#newmonster 3854
-- #copystats 888 -- couldn't get rid of homeshape and stupid
...
#cleanshape
#maxage 9000
-- TODO: should not be undisciplined
#heal
#gcost 0
#mr 16
#end
